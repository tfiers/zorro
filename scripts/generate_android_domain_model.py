...
{attr_sep.join([f"    var {field}: String? = null" for field in simple_fields])}
}}

enum class ItemType(camelCaseName: String, friendlyName: String) {{
{enum_entry_sep.join(map(str, item_type_enum_entries))}
}}

enum class Field(camelCaseName: String, friendlyName: String) {{
{enum_entry_sep.join(map(str, field_enum_entries))}
}}

enum class CreatorType(camelCaseName: String, friendlyName: String, itemType: ItemType) {{
{enum_entry_sep.join(map(str, creator_types_enum_entries))}
}}
""".lstrip()
